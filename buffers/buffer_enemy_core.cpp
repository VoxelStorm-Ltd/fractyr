...
GLuint buffer_enemy_core::shader = 0;
GLuint buffer_enemy_core::attrib_coords = 0;
GLuint buffer_enemy_core::attrib_normal = 0;
GLuint buffer_enemy_core::attrib_colour = 0;

buffer_enemy_core::buffer_enemy_core() {
  /// Default constructor
}
...
void buffer_enemy_core::load_shader() {
...
void buffer_enemy_core::destroy_shader() {
...
void buffer_enemy_core::setup() {
  ...
  Vector4f const bodycolour(  0.9, 0.9, 0.3, 1.0);
  Vector4f const panelcolour( 0.0, 0.0, 0.0, 1.0);

  //Body
  cuboid(Vector3f(0.0, 0.0, 0.0), Vector3f(5.0, 1.5, 1.5), bodycolour, vbodata, ibodata);
  cuboid(Vector3f(0.0, 0.0, 0.0), Vector3f(1.5, 3.0, 1.5), bodycolour, vbodata, ibodata);

  //Panels
  cuboid(Vector3f( 2.5, 0.0, 0.0), Vector3f(0.5, 3.5, 3.5), panelcolour, vbodata, ibodata);
  cuboid(Vector3f(-2.5, 0.0, 0.0), Vector3f(0.5, 3.5, 3.5), panelcolour, vbodata, ibodata);
...
void buffer_enemy_core::render() const {
...
void buffer_enemy_core::cuboid(Vector3f const pos, Vector3f const size, Vector4f colour, std::vector<vertex> &vbodata, std::vector<GLuint> &ibodata) {
